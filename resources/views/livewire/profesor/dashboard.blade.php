<div class="p-6 min-h-screen bg-gray-100">
    ...
    <div id="lista-alumnos" class="bg-white rounded-xl shadow p-6">
        ...
        {{-- Buscador: sin <form>; Enter => Livewire (no GET) --}}
        <div class="mb-4 relative">
            ...
            <ul class="absolute z-10 bg-white shadow-md rounded mt-1 w-full max-h-64 overflow-auto border">
                ...
                <li class="p-2 hover:bg-gray-100">
                    <a wire:navigate href="{{ url()->current() }}?ver={{ $sug->id }}#detalle-alumno"
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="p-3">
                            <div class="flex items-center gap-2">
                                ...
                                <a wire:navigate href="{{ url()->current() }}#lista-alumnos"
                                    class="px-3 py-1 bg-gray-500 text-white rounded hover:bg-gray-600 transition-colors">
                                    Ocultar
                                </a>
                                @else
                                <a wire:navigate href="{{ url()->current() }}?ver={{ $alumno->id }}#detalle-alumno"
    ...
    {{-- Ancla persistente para bajar siempre --}}
