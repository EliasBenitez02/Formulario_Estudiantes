...
@section('content')
<div class="min-h-screen w-full bg-white flex flex-col" x-data="{ openModal: false }">
    <div class="min-h-screen w-full bg-white flex flex-col">
            ...
            <div class="max-w-7xl mx-auto px-4 flex justify-between items-center">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <h1 class="text-lg font-bold">Panel del Profesor</h1>
                    </div>
                </div>
        ...
        <main class="flex-1 w-full px-6 py-4">
            <div class="bg-white rounded-xl shadow-lg p-6 md:p-10 flex flex-col">
                ...
                <!-- Buscador -->
                <div class="mb-6">
                    <input type="text" wire:model.debounce.300ms="search" placeholder="Buscar por nombre, email..."
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                </div>

                <!-- Lista de alumnos tipo tabla -->
                @if($alumnos->isEmpty())
