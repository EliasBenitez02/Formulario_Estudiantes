<div class="p-6 min-h-screen bg-gray-100">
    ...
    <div class="bg-white rounded-xl shadow p-6 flex items-center gap-6 mb-8">
        <img src="<?php echo e(auth()->user()->profile_photo ? asset(auth()->user()->profile_photo) : 'https://ui-avatars.com/api/?name='.auth()->user()->name); ?>"
            class="w-20 h-20 rounded-full object-cover border-2 border-blue-500 cursor-pointer"
            wire:click="verFotoPerfil('<?php echo e(auth()->user()->profile_photo ? asset(auth()->user()->profile_photo) : 'https://ui-avatars.com/api/?name='.auth()->user()->name); ?>')">
        <div>
            <p class="font-bold text-xl"><?php echo e(auth()->user()->name); ?></p>
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="mb-4 relative">
            ...
            <!--[if BLOCK]><![endif]--><?php if(strlen($q) >= 4 && $sugerencias->isNotEmpty()): ?>
            <ul class="absolute z-10 bg-white shadow-md rounded mt-1 w-full max-h-64 overflow-auto">
                ...
                <li wire:click="verAlumno(<?php echo e($sug->id); ?>)"
                    wire:key="sug-<?php echo e($sug->id); ?>"
                    class="p-2 cursor-pointer hover:bg-gray-100">
                    <?php echo e($sug->name); ?> (<?php echo e($sug->email); ?>)
                </li>
            ...
            <table class="w-full border-collapse">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        <td class="p-3">
                            <img src="<?php echo e($alumno->profile_photo ? asset($alumno->profile_photo) : 'https://ui-avatars.com/api/?name='.$alumno->name); ?>"
                                class="w-12 h-12 rounded-full object-cover border-2 border-green-400 cursor-pointer"
                                wire:click="verFotoPerfil('<?php echo e($alumno->profile_photo ? asset($alumno->profile_photo) : 'https://ui-avatars.com/api/?name='.$alumno->name); ?>')">
                        </td>
                        ...
                        <td class="p-3 flex gap-2">
                            ...
                            <a href="https://wa.me/<?php echo e($alumno->whatsapp); ?>" target="_blank" title="WhatsApp">
                        ...
                        <td class="p-3 flex gap-2">
                            <button wire:click="toggleVerAlumno(<?php echo e($alumno->id); ?>)"
                            ...
                            <button wire:click="eliminarAlumno(<?php echo e($alumno->id); ?>)" class="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div class="mt-8 p-6 bg-white rounded-xl shadow flex flex-col md:flex-row gap-6 items-center">
        <img src="<?php echo e($alumnoSeleccionado->profile_photo ? asset($alumnoSeleccionado->profile_photo) : 'https://ui-avatars.com/api/?name='.$alumnoSeleccionado->name); ?>"
            class="w-32 h-32 rounded-full object-cover border-2 border-green-400 cursor-pointer"
            wire:click="verFotoPerfil('<?php echo e($alumnoSeleccionado->profile_photo ? asset($alumnoSeleccionado->profile_photo) : 'https://ui-avatars.com/api/?name='.$alumnoSeleccionado->name); ?>')">
        <div>
            ...
            <ul class="space-y-2">
                ...
                <li><strong>WhatsApp:</strong>
                    ...
                    <a href="https://wa.me/<?php echo e($alumnoSeleccionado->whatsapp); ?>" target="_blank" class="text-green-600 underline">
    ...
    <div class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
        <div class="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
            ...
            <ul class="space-y-2">
                ...
                <li><strong>Comisión:</strong> <?php echo e(auth()->user()?->comision ?? '-'); ?></li>
                <li><strong>Carrera:</strong> <?php echo e(auth()->user()?->carrera ?? '-'); ?></li>
            </ul>
