                            ...
                            <h2 class="text-3xl font-bold mb-6 text-center text-blue-700">Crear cuenta</h2>
                                <form method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data" class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="relative">
                                            <input type="text" name="name" placeholder=" Nombre completo" class="w-full pl-10 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required value="<?php echo e(old('name')); ?>">
                                        ...
                                        <div class="relative">
                                            <input type="email" name="email" placeholder=" Correo electrónico" class="w-full pl-10 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="relative">
                                            <input type="text" name="whatsapp" placeholder=" WhatsApp" class="w-full pl-10 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required value="<?php echo e(old('whatsapp')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="relative">
                                            <input type="text" name="dni" placeholder=" DNI" class="w-full pl-10 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required value="<?php echo e(old('dni')); ?>">
                                            <?php $__errorArgs = ['dni'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="relative">
                                            <input type="text" name="carrera" placeholder=" Carrera" class="w-full pl-10 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required value="<?php echo e(old('carrera')); ?>">
                                        ...
                                        <div class="relative">
                                            <input type="date" name="fecha_nacimiento" placeholder=" Fecha de nacimiento" class="w-full pl-10 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required value="<?php echo e(old('fecha_nacimiento')); ?>">
                                        ...
                                        <div>
                                            <select name="course_id" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                                                ...
                                                <?php $__currentLoopData = $cursos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($curso->id); ?>" <?php echo e(old('role_id') == $curso->id ? 'selected' : ''); ?>><?php echo e($curso->name); ?></option>
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:underline font-semibold">Inicia sesión</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\perfil\resources\views/auth/register.blade.php ENDPATH**/ ?>