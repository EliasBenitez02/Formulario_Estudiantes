  ...
  <main class="mx-auto max-w-6xl px-4 sm:px-6 py-4 space-y-4 sm:space-y-6">
    ...
    <section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div class="flex items-center justify-between px-4 sm:px-5 py-3 border-b border-slate-100">
        ...
        <!--[if BLOCK]><![endif]--><?php if(!$editando): ?>
      ...
      <div class="px-4 sm:px-6 py-5">
        <!-- AVATAR -->
        <div class="mb-4">
          <!--[if BLOCK]><![endif]--><?php if($alumno->profile_photo): ?>
            <img src="<?php echo e(asset('storage/'.$alumno->profile_photo)); ?>" class="h-16 w-16 rounded-full object-cover ring-2 ring-blue-50" alt="Foto">
          <?php else: ?>
            <div class="h-16 w-16 rounded-full bg-slate-200 ring-2 ring-slate-100 flex items-center justify-center text-slate-600 font-semibold">
              <?php echo e(strtoupper(substr($alumno->name,0,1))); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(!$editando): ?>
          ...
          <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div class="space-y-1">
              ...
              <div class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-800"><?php echo e($nombre ?? $alumno->name); ?></div>
            </div>

            <div class="space-y-1">
              <label class="text-[12px] text-slate-500">Correo electrónico</label>
              <div class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-800 truncate"><?php echo e($email ?? $alumno->email); ?></div>
            </div>

            <div class="space-y-1">
              <label class="text-[12px] text-slate-500">WhatsApp</label>
              <div class="relative">
                <div class="rounded-xl border border-slate-200 bg-slate-50 pl-3 pr-9 py-2.5 text-sm text-slate-800"><?php echo e($whatsapp ?: ($alumno->whatsapp ?? '—')); ?></div>
          ...
          <div class="space-y-1">
              ...
              <div class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-800">
                <?php echo e($alumno->course ? $alumno->course->name : '—'); ?>
            ...
            <div class="space-y-1">
              ...
              <div class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-800"><?php echo e($dni ?: '—'); ?></div>
            </div>

            <div class="space-y-1">
              <label class="text-[12px] text-slate-500">Carrera</label>
              <div class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-800"><?php echo e($carrera ?: ($alumno->carrera ?? '—')); ?></div>
            </div>
            ...
            <div class="space-y-1 sm:col-span-2">
              ...
              <div class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-800">
                <?php echo e($fecha ? \Illuminate\Support\Carbon::parse($fecha)->format('d/m/Y') : '—'); ?>
            ...
            <div class="space-y-1 sm:col-span-2">
              ...
              <div class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-800">
                ...
                ?>
                <!--[if BLOCK]><![endif]--><?php if($sp && ($sp->linkedin || $sp->github || $sp->gitlab || $sp->wordpress || $sp->notion)): ?>
                  <div class="flex flex-wrap gap-2">
                    <!--[if BLOCK]><![endif]--><?php if($sp->linkedin): ?>
                      <a href="<?php echo e($sp->linkedin); ?>" target="_blank" class="inline-flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-xs border-slate-200 text-blue-700 bg-white hover:bg-slate-50">
                        <span class="i">in</span> LinkedIn
                      </a>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <!--[if BLOCK]><![endif]--><?php if($sp->github): ?>
                      <a href="<?php echo e($sp->github); ?>" target="_blank" class="inline-flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-xs border-slate-200 text-slate-700 bg-white hover:bg-slate-50">
                    ...
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <!--[if BLOCK]><![endif]--><?php if($sp->gitlab): ?>
                      <a href="<?php echo e($sp->gitlab); ?>" target="_blank" class="inline-flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-xs border-slate-200 text-orange-700 bg-white hover:bg-slate-50">
                        GitLab
                      </a>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <!--[if BLOCK]><![endif]--><?php if($sp->wordpress): ?>
                      <a href="<?php echo e($sp->wordpress); ?>" target="_blank" class="inline-flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-xs border-slate-200 text-indigo-700 bg-white hover:bg-slate-50">
                        WordPress
                      </a>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <!--[if BLOCK]><![endif]--><?php if($sp->notion): ?>
                      <a href="<?php echo e($sp->notion); ?>" target="_blank" class="inline-flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-xs border-slate-200 text-black bg-white hover:bg-slate-50">
                        Notion
                      </a>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                  </div>
        ...
        <?php else: ?>
          ...
          <div class="grid lg:grid-cols-2 gap-6">
            <div class="rounded-xl border border-slate-100 bg-slate-50 p-4 text-sm">
              ...
              <div class="space-y-1">
                <p><span class="text-slate-500">Nombre:</span> <span class="font-medium text-slate-800"><?php echo e($alumno->name); ?></span></p>
                <p><span class="text-slate-500">Email:</span> <span class="font-medium text-slate-800"><?php echo e($alumno->email); ?></span></p>
                <!--[if BLOCK]><![endif]--><?php if($alumno->whatsapp): ?><p><span class="text-slate-500">WhatsApp:</span> <span class="font-medium text-slate-800"><?php echo e($alumno->whatsapp); ?></span></p><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($alumno->comision): ?><p><span class="text-slate-500">Comisión:</span> <span class="font-medium text-slate-800"><?php echo e($alumno->comision); ?></span></p><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($alumno->carrera): ?><p><span class="text-slate-500">Carrera:</span> <span class="font-medium text-slate-800"><?php echo e($alumno->carrera); ?></span></p><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
              </div>
            </div>
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-rose-600 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
              ...
              <div>
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nuevaFoto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-rose-600 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($nuevaFoto): ?>
                  <img src="<?php echo e($nuevaFoto->temporaryUrl()); ?>" class="h-14 w-14 rounded-full object-cover mt-3 ring-2 ring-blue-100" alt="Preview">
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
              </div>
...
<section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
  ...
  <!--[if BLOCK]><![endif]--><?php if($profesor): ?>
    <div class="p-4 sm:p-6">
      <article class="p-4 rounded-2xl border border-slate-200 bg-white hover:shadow-sm transition">
        <div class="flex items-center gap-3">
          <!--[if BLOCK]><![endif]--><?php if($profesor->profile_photo): ?>
            <img src="<?php echo e(asset('storage/'.$profesor->profile_photo)); ?>"
          ...
          <?php else: ?>
            <div class="h-12 w-12 rounded-full bg-slate-200 ring-2 ring-slate-100 flex items-center justify-center text-slate-600 font-semibold">
              <?php echo e(strtoupper(substr($profesor->name,0,1))); ?>

            </div>
          <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
          <div class="leading-tight">
            <h3 class="text-slate-800 font-medium">Prof. <?php echo e($profesor->name); ?></h3>
            <p class="text-[11px] text-slate-500 -mt-0.5">Profesor</p>
            <a class="text-xs text-blue-600 underline" href="mailto:<?php echo e($profesor->email); ?>"><?php echo e($profesor->email); ?></a>
            <div class="flex gap-2 mt-2 flex-wrap">
              <!--[if BLOCK]><![endif]--><?php if($profesor->whatsapp): ?>
                <a href="https://wa.me/<?php echo e($profesor->whatsapp); ?>" target="_blank" rel="noopener" title="WhatsApp" class="text-green-500 hover:text-green-700">
              ...
              <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
              <?php $sp = $profesor->socialProfile ?? null; ?>
              <!--[if BLOCK]><![endif]--><?php if($sp): ?>
                <!--[if BLOCK]><![endif]--><?php if($sp->github): ?>
                  <a href="<?php echo e($sp->github); ?>" target="_blank" rel="noopener" title="GitHub" class="text-gray-800 hover:text-black">
                ...
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($sp->gitlab): ?>
                  <a href="<?php echo e($sp->gitlab); ?>" target="_blank" rel="noopener" title="GitLab" class="text-orange-500 hover:text-orange-700">
                    <svg class="w-6 h-6 inline" viewBox="0 0 24 24" fill="currentColor">
                ...
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($sp->notion): ?>
                  <a href="<?php echo e($sp->notion); ?>" target="_blank" rel="noopener" title="Notion" class="text-gray-800 hover:text-black">
                    <svg class="w-6 h-6 inline" viewBox="0 0 24 24" fill="currentColor">
                ...
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($sp->wordpress): ?>
                  <a href="<?php echo e($sp->wordpress); ?>" target="_blank" rel="noopener" title="WordPress" class="text-blue-500 hover:text-blue-700">
                    <svg class="w-6 h-6 inline" viewBox="0 0 24 24" fill="currentColor">
                ...
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                <!--[if BLOCK]><![endif]--><?php if($sp->linkedin): ?>
                  <a href="<?php echo e($sp->linkedin); ?>" target="_blank" rel="noopener" title="LinkedIn" class="text-blue-600 hover:text-blue-800">
                    <svg class="w-6 h-6 inline" viewBox="0 0 24 24" fill="currentColor">
...
<?php /**PATH C:\xampp\htdocs\perfil\resources\views/livewire/student/student-dashboard.blade.php ENDPATH**/ ?>