    ...
    <div class="w-full max-w-lg mx-auto px-2 sm:px-0">
        <div class="bg-white shadow-xl rounded-2xl px-4 py-8 sm:px-8 sm:py-12">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
                ...
                <?php endif; ?>
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Correo electrónico" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                <div class="relative">
            ...
            <div class="mt-4 text-center">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:underline font-semibold">Regístrate</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\perfil\resources\views/auth/login.blade.php ENDPATH**/ ?>