    ...
    <div class="p-6 min-h-screen bg-gray-100 scroll-smooth">
        ...
        <div class="bg-white rounded-xl shadow p-6 flex flex-col sm:flex-row items-center gap-6 mb-8">
            <img
                ...
                wire:click="verFotoPerfil('<?php echo e(auth()->user()->profile_photo
                    ? asset('storage/'.auth()->user()->profile_photo)
                    : 'https://ui-avatars.com/api/?name='.urlencode(auth()->user()->name)); ?>')">

            <div class="text-center sm:text-left">
                <p class="font-bold text-xl text-blue-700"><?php echo e(auth()->user()->name); ?></p>
        ...
        <div id="lista-alumnos" class="bg-white rounded-xl shadow p-6">
            ...
            <div class="mb-4 relative">
                ...
                <!--[if BLOCK]><![endif]--><?php if(strlen($q) >= 4): ?>
                <!--[if BLOCK]><![endif]--><?php if($sugerencias->isNotEmpty()): ?>
                <ul class="absolute left-0 right-0 mt-1 max-h-64 overflow-auto rounded border bg-white shadow-md z-50">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sugerencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="?ver=<?php echo e($sug->id); ?>#detalle-alumno"
                            class="flex items-center gap-2 p-2 hover:bg-gray-100 cursor-pointer">
                            <img src="<?php echo e($sug->profile_photo ? asset('storage/'.$sug->profile_photo) : 'https://ui-avatars.com/api/?name='.urlencode($sug->name)); ?>"
                                class="w-8 h-8 rounded-full object-cover">
                            <span><?php echo e($sug->name); ?> (<?php echo e($sug->email); ?>)</span>
                        </a>
                    </li>
                ...
                <table class="w-full border-collapse">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            <td class="p-3">
                                <img
                                    src="<?php echo e($alumno->profile_photo
                                    ...
                                    wire:click="verFotoPerfil('<?php echo e($alumno->profile_photo
                                            ? asset('storage/'.$alumno->profile_photo)
                                            : 'https://ui-avatars.com/api/?name='.urlencode($alumno->name)); ?>')">
                            </td>

                            <td class="p-3 font-medium"><?php echo e($alumno->name); ?></td>
                            <td class="p-3"><?php echo e($alumno->email); ?></td>

                            
                            <td class="p-3">
                                <div class="flex flex-wrap items-center gap-2">
                                    <!--[if BLOCK]><![endif]--><?php if($alumno->whatsapp): ?>
                                    <a href="https://wa.me/<?php echo e($alumno->whatsapp); ?>" target="_blank" rel="noopener" title="WhatsApp" class="text-green-500 hover:text-green-700">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($alumno->socialProfile): ?>
                                    <!--[if BLOCK]><![endif]--><?php if($alumno->socialProfile->github): ?>
                                    <a href="<?php echo e($alumno->socialProfile->github); ?>" target="_blank" rel="noopener" title="GitHub" class="text-gray-800 hover:text-black">
                                    ...
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($alumno->socialProfile->gitlab): ?>
                                    <a href="<?php echo e($alumno->socialProfile->gitlab); ?>" target="_blank" rel="noopener" title="GitLab" class="text-orange-500 hover:text-orange-700">
                                        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($alumno->socialProfile->notion): ?>
                                    <a href="<?php echo e($alumno->socialProfile->notion); ?>" target="_blank" rel="noopener" title="Notion" class="text-gray-800 hover:text-black">
                                        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($alumno->socialProfile->wordpress): ?>
                                    <a href="<?php echo e($alumno->socialProfile->wordpress); ?>" target="_blank" rel="noopener" title="WordPress" class="text-blue-500 hover:text-blue-700">
                                        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($alumno->socialProfile->linkedin): ?>
                                    <a href="<?php echo e($alumno->socialProfile->linkedin); ?>" target="_blank" rel="noopener" title="LinkedIn" class="text-blue-600 hover:text-blue-800">
                                        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <td class="p-3">
                                <div class="flex items-center gap-2">
                                    <!--[if BLOCK]><![endif]--><?php if($alumnoSeleccionado && $alumnoSeleccionado->id === $alumno->id): ?>
                                    
                                    <a href="<?php echo e(request()->url()); ?>#lista-alumnos"
                                        class="px-3 py-1 bg-gray-500 text-white rounded hover:bg-gray-600 transition-colors">
                                        Ocultar
                                    </a>
                                    <?php else: ?>
                                    
                                    <a href="<?php echo e(request()->url()); ?>?ver=<?php echo e($alumno->id); ?>#detalle-alumno"
                                    ...
                                    <button type="button"
                                        wire:click="confirmarEliminar(<?php echo e($alumno->id); ?>)"
        ...
        <div class="mt-8 p-6 bg-white rounded-xl shadow flex flex-col md:flex-row gap-6 items-center">
            <img
                ...
                wire:click="verFotoPerfil('<?php echo e($alumnoSeleccionado->profile_photo
                        ? asset('storage/'.$alumnoSeleccionado->profile_photo)
                        : 'https://ui-avatars.com/api/?name='.urlencode($alumnoSeleccionado->name)); ?>')">
            <div>
                <h2 class="text-xl font-bold mb-3 text-blue-700">Detalles del Alumno</h2>
                <ul class="space-y-2">
                    <li><strong>Nombre:</strong> <?php echo e($alumnoSeleccionado->name ?? '-'); ?></li>
                    <li><strong>Email:</strong> <?php echo e($alumnoSeleccionado->email ?? '-'); ?></li>
                    <li><strong>WhatsApp:</strong>
                        <!--[if BLOCK]><![endif]--><?php if($alumnoSeleccionado->whatsapp): ?>
                        <a href="https://wa.me/<?php echo e($alumnoSeleccionado->whatsapp); ?>" target="_blank" class="text-green-600 underline" rel="noopener">
                            <?php echo e($alumnoSeleccionado->whatsapp); ?>
                    ...
                    <li><strong>DNI:</strong> <?php echo e($alumnoSeleccionado->dni ?? '-'); ?></li>
                    <li><strong>Fecha de Nacimiento:</strong> <?php echo e($alumnoSeleccionado->fecha_nacimiento ?? '-'); ?></li>
                    <li><strong>Comisión:</strong> <?php echo e($alumnoSeleccionado->comision ?? '-'); ?></li>
                    <li><strong>Carrera:</strong> <?php echo e($alumnoSeleccionado->carrera ?? '-'); ?></li>
                </ul>
            </div>
        </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <!--[if BLOCK]><![endif]--><?php if($mostrarEditarPerfil): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if(!empty($confirmarEliminarId)): ?>
        <div class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
                ...
                <div class="flex gap-2 mt-4 justify-end">
                    ...
                    <button type="button" wire:click="eliminarAlumno(<?php echo e($confirmarEliminarId); ?>)" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 transition-colors">Sí, eliminar</button>
                </div>
            </div>
        </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

        <!--[if BLOCK]><![endif]--><?php if($fotoPerfilGrande): ?>
        <div class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50" wire:click="cerrarFotoPerfil">
            <img src="<?php echo e($fotoPerfilGrande); ?>" class="max-w-lg max-h-[80vh] rounded-xl shadow-2xl border-4 border-white">
        </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

        <!--[if BLOCK]><![endif]--><?php if($mostrarAcercaDe): ?>
        <div class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded-xl shadow-lg w-full max-w-md">
                ...
                <ul class="space-y-2">
                    ...
                    <li><strong>DNI:</strong> <?php echo e(auth()->user()?->dni ?? '-'); ?></li>
                    <li><strong>WhatsApp:</strong> <?php echo e(auth()->user()?->whatsapp ?? '-'); ?></li>
                    <li><strong>Fecha de Nacimiento:</strong> <?php echo e(auth()->user()?->fecha_nacimiento ?? '-'); ?></li>
                    <li><strong>Curso:</strong> <?php echo e(auth()->user()?->course?->name ?? '-'); ?></li>
                    <li><strong>Descripción del Curso:</strong> <?php echo e(auth()->user()?->course?->description ?? '-'); ?></li>
                </ul>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </div><?php /**PATH C:\xampp\htdocs\perfil\resources\views/livewire/profesor/dashboard.blade.php ENDPATH**/ ?>